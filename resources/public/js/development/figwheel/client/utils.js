...
return (new CustomEvent(event_name,(function (){var obj25595 = {"detail":data};
return obj25595;
})()));
} else {
...
var f = (function (){var pred__25602 = cljs.core._EQ_;
var expr__25603 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__25602.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__25603))){
return ((function (pred__25602,expr__25603){
return (function (p1__25596_SHARP_){
return console.warn(p1__25596_SHARP_);
});
;})(pred__25602,expr__25603))
} else {
if(cljs.core.truth_(pred__25602.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__25603))){
return ((function (pred__25602,expr__25603){
return (function (p1__25597_SHARP_){
return console.debug(p1__25597_SHARP_);
});
;})(pred__25602,expr__25603))
} else {
if(cljs.core.truth_(pred__25602.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__25603))){
return ((function (pred__25602,expr__25603){
return (function (p1__25598_SHARP_){
return console.error(p1__25598_SHARP_);
});
;})(pred__25602,expr__25603))
} else {
return ((function (pred__25602,expr__25603){
return (function (p1__25599_SHARP_){
return console.log(p1__25599_SHARP_);
});
;})(pred__25602,expr__25603))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__25606){
var map__25607 = p__25606;
var map__25607__$1 = (((((!((map__25607 == null))))?(((((map__25607.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25607.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25607):map__25607);
var opts = map__25607__$1;
var eval_fn = cljs.core.get.call(null,map__25607__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__25609_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__25611,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1553581594077
