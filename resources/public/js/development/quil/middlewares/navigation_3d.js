...
var vec__21752 = axis;
var a_x = cljs.core.nth.call(null,vec__21752,(0),null);
var a_y = cljs.core.nth.call(null,vec__21752,(1),null);
var a_z = cljs.core.nth.call(null,vec__21752,(2),null);
var vec__21755 = v;
var x = cljs.core.nth.call(null,vec__21755,(0),null);
var y = cljs.core.nth.call(null,vec__21755,(1),null);
var z = cljs.core.nth.call(null,vec__21755,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__21758,p__21759){
var vec__21760 = p__21758;
var u1 = cljs.core.nth.call(null,vec__21760,(0),null);
var u2 = cljs.core.nth.call(null,vec__21760,(1),null);
var u3 = cljs.core.nth.call(null,vec__21760,(2),null);
var vec__21763 = p__21759;
var v1 = cljs.core.nth.call(null,vec__21763,(0),null);
var v2 = cljs.core.nth.call(null,vec__21763,(1),null);
var v3 = cljs.core.nth.call(null,vec__21763,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__21766_SHARP_){
return (p1__21766_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__21767_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__21768_SHARP_,angle_lr),angle_ud);
...
var map__21770 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__21770__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__21770__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5718__auto__ = (function (){var pred__21772 = cljs.core._EQ_;
var expr__21773 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__21772.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__21773))){
return straight;
} else {
if(cljs.core.truth_(pred__21772.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__21773))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__21772.call(null,quil.middlewares.navigation_3d.space,expr__21773))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__21772.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__21773))){
return up;
} else {
if(cljs.core.truth_(pred__21772.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__21773))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__21772.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__21773))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5718__auto__,map__21770,map__21770__$1,up,straight){
return (function (p1__21769_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__21769_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5718__auto__,map__21770,map__21770__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__21775_SHARP_);
});})(initial_state))
);
});
/**
...
var map__21776_21787 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__21776_21788__$1 = (((((!((map__21776_21787 == null))))?(((((map__21776_21787.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21776_21787.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21776_21787):map__21776_21787);
var vec__21777_21789 = cljs.core.get.call(null,map__21776_21788__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_21790 = cljs.core.nth.call(null,vec__21777_21789,(0),null);
var c_y_21791 = cljs.core.nth.call(null,vec__21777_21789,(1),null);
var c_z_21792 = cljs.core.nth.call(null,vec__21777_21789,(2),null);
var vec__21780_21793 = cljs.core.get.call(null,map__21776_21788__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_21794 = cljs.core.nth.call(null,vec__21780_21793,(0),null);
var u_y_21795 = cljs.core.nth.call(null,vec__21780_21793,(1),null);
var u_z_21796 = cljs.core.nth.call(null,vec__21780_21793,(2),null);
var vec__21783_21797 = cljs.core.get.call(null,map__21776_21788__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_21798 = cljs.core.nth.call(null,vec__21783_21797,(0),null);
var p_y_21799 = cljs.core.nth.call(null,vec__21783_21797,(1),null);
var p_z_21800 = cljs.core.nth.call(null,vec__21783_21797,(2),null);
quil.core.camera.call(null,p_x_21798,p_y_21799,p_z_21800,(p_x_21798 + c_x_21790),(p_y_21799 + c_y_21791),(p_z_21800 + c_z_21792),u_x_21794,u_y_21795,u_z_21796);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1553581585295
