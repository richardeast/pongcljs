...
return cljs.core.merge.call(null,initial_state,p1__22299_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_22300 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_22301 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_22300);
var pos_22302 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_22300);
quil.core.scale.call(null,zoom_22301);

var tr__22199__auto___22303 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_22301) - cljs.core.first.call(null,pos_22302)),(((quil.core.height.call(null) / (2)) / zoom_22301) - cljs.core.second.call(null,pos_22302))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__22199__auto___22303);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1553581586070
